...
def generate_launch_description():
    ...
    default_graph = os.path.join(nav_share, "maps", "map20_04.geojson")
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                ...
                description="Path to route_server geojson",
            ),
            DeclareLaunchArgument(
                "use_rviz",
                default_value="true",
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    os.path.join(
                        nav_share, "launch", "nav2_route_with_static_map.launch.py"
                    )
                ),
                launch_arguments={
                    "use_sim_time": use_sim_time,
...
#                    "map": map_yaml,
            ...
            # Chạy script điều khiển lộ trình (tương đương bước 2: route_demo.launch.py)
            Node(
