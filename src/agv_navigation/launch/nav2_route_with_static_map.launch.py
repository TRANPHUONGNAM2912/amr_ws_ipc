...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "graph",
                default_value=pkg_share + "/maps/map20_04.geojson",
                description="Path to graph geojson for route_server",
            ),
            DeclareLaunchArgument(
            ...
            Node(
                ...
                name="route_server",
                output="screen",
                parameters=params_files + [{"use_sim_time": use_sim_time, "graph_filepath": graph_filepath}],
            ),
            Node(
